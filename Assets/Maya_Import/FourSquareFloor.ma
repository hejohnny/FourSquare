...
//Name: FourSquareFloor.ma
//Last modified: Tue, Mar 04, 2014 10:34:17 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.26529200628099497 13.545756494768174 -1.7541616450330393 ;
	setAttr ".r" -type "double3" 277.461647272655 548.59999999997535 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.661441429846212;
...
createNode transform -n "nurbsCube1";
	setAttr ".t" -type "double3" 1.0873154742481042 0 -1.6349516417030392 ;
...
createNode polyCube -n "polyCube1";
	setAttr ".w" 5.9657313422889953;
	setAttr ".h" 0.8080271101234181;
	setAttr ".d" 6.9331724942912061;
	setAttr ".cuv" 4;
createNode makeNurbCube -n "makeNurbCube1";
	setAttr ".ax" -type "double3" 0 1 0 ;
createNode brush -n "art3dPaintLastPaintBrush";
	setAttr ".cl1" -type "float3" 0.17399999 0.17399999 1 ;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/Users/Johnny/Documents/maya/projects/default//default/3dPaintTextures/FourSquareFloor/pCubeShape1_color.png";
